...
export const payoutAccounts: PayoutAccount[] = [
  ...
  { id: "2", refNo: "1106", name: "John Doe", currency: "GBP", bank: "Barclays", accountNumber: "12312300011", routingNumber: "20-45-67", activated: true, isDefault: true },
...
export function getDefaultPayoutAccount(): PayoutAccount | undefined {
  return payoutAccounts.find(a => a.activated && a.isDefault) || payoutAccounts.find(a => a.activated);
}
