...
export function Header({ userName, onMenuClick }: HeaderProps) {
  return (
    <motion.header 
      ...
      className="h-16 bg-white border-b border-border flex items-center justify-between px-4 md:px-6 sticky top-0 z-40"
    >
      <button 
        onClick={onMenuClick}
      ...
      <div className="flex items-center gap-2 md:gap-4 ml-auto">
        ...
        <div className="flex items-center gap-2 md:gap-3 cursor-pointer" data-testid="button-profile-menu">
